...
function totalPasswd(){
  
  countPasswd=$(wc -l $rockyou_file | awk '{print $1}')

  echo -e "${redColour}//${endColour}${grayColour} Rockyou cuenta con${endColour}${BpurpleColour} $countPasswd${endColour}${grayColour} contraseñas${endColour}${redColour} //${endColour}"
